...
| 산출물 | 수 | 내용 |
|---|---|---|
| 결정 청크 (`chunks/decision/`) | 135 | d-0001 이 저장소의 하네스 채택 / d-0002~d-0012·d-0021~d-0155 **체계 전체**(명명 규약·문제 진술·온톨로지·ODD·청크·plane·사다리·미확정·링크·입력·활용·UX) / d-0013~d-0020 참조 저장소에서 승격 |
| 구성체 (`kg/composite-kg.ttl`) | 32 | 체계의 각 Part별 묶음 — **모든 청크가 어느 구성체의 부분이다(고아 0)** |
...
d-0013~d-0020은 참조 저장소에서 **승격**된 지식이며, 두 경우 모두 원본은 제거되고
출처는 `derived_from`과 git 이력에 남는다.
