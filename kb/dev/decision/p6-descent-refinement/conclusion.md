...
type: decision
level: concrete
title_ko: 하강은 네 전이이며 전이마다 근거와 refines를 남긴다
...
composite: {id: https://agentic-knowledge-base.dev/id/composite/3eec3426-b051-4594-8d32-be0867520885, title_ko: 하강 — 구체화의 네 전이, title: Descent - the four refinement transitions}
---
**결론** — 하강(구체화)은 네 전이다.
...
**각 전이는 근거를 남기고 `refines` 링크를 남긴다** (9.2절). 사다리는 링크로 구현되며 전이의 근거는 링크의 속성이다.
