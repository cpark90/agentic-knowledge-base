---
id: https://agentic-knowledge-base.dev/id/chunk/de54cf29-cd0a-4dce-ae86-ed5583597a70
type: decision
level: logical
title_ko: 평가 생략과 자동 귀속의 기각
...
**대안** — verifier 실패의 귀속(산출물/지식/둘 다)을 자동으로 정하는 안. 기각 — 귀속은 결정이며 V&V `decision`의 지도 청크로 남긴다. 진단은 기호 도구가 먼저 한다 (8.4절, v5).
