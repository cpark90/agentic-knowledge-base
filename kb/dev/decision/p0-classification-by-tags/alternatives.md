...
**대안** — 범주 없는 자유 태그. 기각 — 태그가 무한히 늘고 같은 뜻의 표기가
갈라져 검색이 불가능해진다. 0.8절 동의어 등록도 값이 개념일 때만 걸린다.

**계승** — 태그 규칙 자체는 v1 d-0012의 "분류는 태그로" 부분에서 왔고,
그 결정의 나머지(scene·situation·scenario 3분리)는 폐기되었다.
