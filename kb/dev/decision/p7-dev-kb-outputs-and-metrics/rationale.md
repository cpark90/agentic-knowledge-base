...
type: decision
level: logical
title_ko: 산출은 전부 투영이고 지표는 전부 질의다
...
---
**근거** (노트 7.8절, 4.6절, 12.3절) — 코드·문서·ADR·보고가 저장물이 아니라 투영이어야 청크가 유일한 원본으로 남는다(4.6절). 지표 여섯은 전부 그래프 질의로 나오며, 12.3절의 선택 규칙("낮으면 무엇을 고치는가")을 만족한다 — 완주율·귀속률은 하강 하네스, 완결률은 설계 진행, 체류 시간은 유저 피드백, 선행률·기록률은 게이트.
