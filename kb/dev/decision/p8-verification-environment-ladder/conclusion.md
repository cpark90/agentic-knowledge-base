...
type: decision
level: concrete
title_ko: 검증 환경은 여섯 단계 사다리이고 피라미드 형태를 유지한다
...
composite: {id: https://agentic-knowledge-base.dev/id/composite/ea0859cb-27fc-4f71-a6a9-66d5e96be952, title_ko: 검증 환경의 사다리, title: The ladder of verification environments}
---
...
2. **모델** — 구성체 단위, 구현 없이 계약만으로 정합 검사 / 스코프 하나로 작업 집합 조립, 질의 결과 검사
