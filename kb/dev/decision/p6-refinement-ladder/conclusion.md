...
type: decision
level: concrete
title_ko: level은 요구에서 산출물까지의 정제 높이다
...
composite: {id: https://agentic-knowledge-base.dev/id/composite/5ef6f4a9-343a-4f00-8e88-172521022d6b, title_ko: 정제 사다리의 정의, title: Definition of the refinement ladder}
---
**결론** — level은 **요구에서 실산출물까지의 정제 높이**다. plane과 직교하고, 모든 지식은 다섯 단계 중 하나에 거주하며 단계마다 거주 plane과 판정 방식이 정해져 있다.
...
**양 끝이 plane 전용이다.** 사다리는 요구에서 시작해 산출물에서 끝나고 그 사이 세 단계가 정제다. 이 정의에서 사다리는 상황의 추상화가 아니라 **요구가 산출물이 되는 사슬**이다.
