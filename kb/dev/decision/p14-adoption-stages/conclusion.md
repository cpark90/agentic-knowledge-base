...
2. ODD·카탈로그·스코프·작업 집합 — 첫 대조 이탈 0, 역할별 작업 집합 200줄 안 / ODD 재작성
...
6. 실행 기록, 상승 트리거, 용어 제안 — 온톨로지 확장 ≥ 1건, 사후분석마다 산출 / 트리거 재설계
7. V&V 프로파일·`vv/`·가로대·독립 스코프 — 기준 바인딩률 100%, 독립성 0건, 가로대 지연 측정 / 가로대를 경고로
